...
class MailChannel extends \Illuminate\Notifications\Channels\MailChannel
{
    ...
    public function send($notifiable, Notification $notification)
    {
        ...
        $sandbox = !empty(Sender::$runningInSandboxValidator) && call_user_func(Sender::$runningInSandboxValidator);
        $valid = !empty(Sender::$validForSandboxValidator) && call_user_func(Sender::$validForSandboxValidator, $to, MailChannel::class);
